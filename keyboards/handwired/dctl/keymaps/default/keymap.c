...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    _______, KC_EXLM, KC_QUES, KC_PLUS, KC_PERC, XXXXXXX,     XXXXXXX, KC_CIRC, _______, _______, _______, _______,
                      _______, _______,                                         _______, _______,
                               OS_FUNC, OS_LSFT, OS_SYM,      OS_SYM,  OS_LSFT, OS_FUNC,
                               OS_LALT, OS_LCTL, OS_LGUI,     OS_LGUI, OS_LCTL, OS_LALT),

    [_NAVIGATION] = LAYOUT(
                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, KC_CAPS, KC_PSCR, KC_INS,  XXXXXXX, XXXXXXX,
    XXXXXXX, KC_HOME, KC_END,  KC_LEFT, KC_RGHT, XXXXXXX,     XXXXXXX, KC_DOWN, KC_UP,   KC_PGDN, KC_PGUP, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                      XXXXXXX, XXXXXXX,                                         XXXXXXX, XXXXXXX,
                               OS_NAV,  OS_LSFT, OS_FUNC,     OS_FUNC, OS_LSFT, OS_NAV,
                               OS_LALT, OS_LCTL, OS_LGUI,     OS_LGUI, OS_LCTL, OS_LALT),
